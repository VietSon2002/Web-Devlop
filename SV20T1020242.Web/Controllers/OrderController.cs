...
namespace SV20T1020242.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult Index(OrderSearchInput searchInput)
        {
            // Lấy dữ liệu tìm kiếm từ form và thực hiện truy vấn cơ sở dữ liệu
            var data = OrderDataService.ListOrders(out int rowCount, searchInput.Page, ORDER_PAGE_SIZE, searchInput.Status, searchInput.FromTime, searchInput.ToTime, searchInput.SearchValue);

            // Tạo đối tượng OrderSearchResult để chứa dữ liệu và truyền nó vào view
        ...
        {
            int rowCount = 0;
            var data = ProductDataService.ListOfProducts(out rowCount, input.Page, input.PageSize, input.SearchValue ?? "");//ListProduct
